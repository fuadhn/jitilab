 ...
 */
  ...
  $current_keyword = ($wp_query->query_vars['s'] ? $wp_query->query_vars['s'] : false);
      ...
      <div class="jtl-custom-container">
        <div class="jtl-space-y-8">
          <div class="jtl-flex jtl-flex-col jtl-gap-4 jtl-items-center">
            <h1 class="jtl-section-title jtl-text-center">
              <?php
                printf(
                  esc_html__( 'Pencarian untuk "%s"', 'kawani' ),
          ...
          <?php if(have_posts()) { ?>
          <div id="jtlAllPosts" class="jtl-grid jtl-grid-cols-1 sm:jtl-grid-cols-2 xl:jtl-grid-cols-3 jtl-gap-4" data-keyword="<?php echo ($current_keyword ? esc_attr($current_keyword) : ''); ?>" data-max="<?php echo esc_attr($max_posts); ?>">
